...
import 'umi_form_screen.dart';

class UmiListScreen extends StatefulWidget {
  const UmiListScreen({super.key});

  @override
  State<UmiListScreen> createState() => _UmiListScreenState();
}

class _UmiListScreenState extends State<UmiListScreen> {
  ...
  void _loadData() {
    setState(() {
      _historyFuture = _umiService.getHistory();
    });
  }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const UmiFormScreen()),
          );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "Belum ada riwayat pendaftaran UMi",
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Nominal: Rp ${item['nominalPengajuan']}",
              style: GoogleFonts.poppins(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Detail Pendaftaran Program UMi",
                style: GoogleFonts.poppins(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              _detailRow("Nominal Pengajuan", "Rp ${item['nominalPengajuan']}"),
              _detailRow("Tujuan Pembiayaan", item['tujuanPembiayaan']),
              ...
              _docItem("Surat Keterangan Usaha", item['skuFile']),
            ],
          ),
        ),
      ),
