...
class LpdbDetailScreen extends StatefulWidget {
  const LpdbDetailScreen({super.key});

  @override
  State<LpdbDetailScreen> createState() => _LpdbDetailScreenState();
}

class _LpdbDetailScreenState extends State<LpdbDetailScreen> {
  ...
  Future<void> _fakeUpload(String field) async {
    ...
    setState(() {
      if (field == 'ktp') {
        ...
        _proposalFile = 'Proposal_Usaha.pdf';
      }
    });
  }
