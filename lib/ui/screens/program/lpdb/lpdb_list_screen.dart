...
import 'lpdb_form_screen.dart';

class LpdbListScreen extends StatefulWidget {
  const LpdbListScreen({super.key});

  @override
  State<LpdbListScreen> createState() => _LpdbListScreenState();
}

class _LpdbListScreenState extends State<LpdbListScreen> {
  ...
  void _loadData() {
    setState(() {
      _historyFuture = _lpdbService.getHistory();
    });
  }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const LpdbFormScreen()),
          );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "Belum ada riwayat pengajuan LPDB",
